...
def _do_token_refresh(refresh_token: str) -> tuple[str, float] | None:
    ...
    """
    def get_antigravity_client_secret(): return os.environ.get("ANTIGRAVITY_CLIENT_SECRET")
    ...
    def get_antigravity_client_id(): return os.environ.get("ANTIGRAVITY_CLIENT_ID")
